...
url = "https://cf59e3fa8892458f9c1178a31821a473.us-central1.gcp.cloud.es.io:9243/api/detection_engine/rules"
		...
		if file.endswith('.toml'):
			...
			with open(full_path,'rb') as toml:
				...
				if alert['rule']['type'] == 'query': # query based alert
					...
					required_fields = ['author', 'description','name','risk_score','severity','type','query', 'threshold', 'threat']
				else:
